...
export Build_Platform_Libs_Path=${Bluetooth_Tool_Dir}/../../../library/gnuarm-4.8.2_neon_ca9/bluedroid/lib
export Build_Platform_Bins_Path=${Bluetooth_Tool_Dir}/../../../library/gnuarm-4.8.2_neon_ca9/bluedroid/bin
...
#######################################--Begin RPC--########################################
echo "start build build_rpc lib"
sh build_rpc.sh
