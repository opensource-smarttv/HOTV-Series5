...
#define MTK_PTS_AV_SINK_ONLY    FALSE//titan: only can open for testing sink role (source role should not open)
...
#define MTK_A2DP_SINK_CODEC_AAC (1)
#else
#define MTK_A2DP_SINK_CODEC_AAC (0)
#endif
