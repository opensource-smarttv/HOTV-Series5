...
extern INT32 x_mtkapi_hidh_deinit(VOID);
...
extern INT32 x_mtkapi_get_paired_hidh_dev_list(BT_HID_TARGET_DEV_LIST *pt_device_list, BT_HID_STATUS_STRUCT_LIST *pt_hid_status_list);
extern INT32 x_mtkapi_del_paired_hidh_dev_one(BT_TARGET_DEV_INFO *pt_device_info);
extern INT32 x_mtkapi_del_paired_hidh_dev_all(VOID);
extern INT32 x_mtkapi_connect_hidh_sources(CHAR *addr);
extern INT32 x_mtkapi_disconnect_hidh_sources(CHAR *addr);
