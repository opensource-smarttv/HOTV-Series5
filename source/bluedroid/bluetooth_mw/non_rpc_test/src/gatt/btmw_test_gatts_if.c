...
static INT32 btmw_test_gatts_register_server(INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_register_server(pt_service_uuid);
}
...
static INT32 btmw_test_gatts_unregister_server(INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_unregister_server(server_if);
}
...
static INT32 btmw_test_gatts_open(INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_open(server_if, ps_addr, is_direct, transport);
}
...
static INT32 btmw_test_gatts_close(INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_close(server_if, ps_addr, conn_id);
}
...
static INT32 btmw_test_gatts_add_service (INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_add_service(server_if, pt_uuid, is_primary, number);
}
...
static INT32 btmw_test_gatts_add_included_service(INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_add_included_service(server_if,service_handle,included_handle);
}
...
static INT32 btmw_test_gatts_add_char (INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_add_char(server_if, service_handle, pt_uuid, properties, permissions);
}
...
static INT32 btmw_test_gatts_add_desc (INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_add_desc(server_if, service_handle, pt_uuid, permissions);
}
...
static INT32 btmw_test_gatts_start_service (INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_start_service(server_if,service_handle,transport);
}
...
static INT32 btmw_test_gatts_stop_service (INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_stop_service(server_if,service_handle);
}
...
static INT32 btmw_test_gatts_delete_service (INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_delete_service(server_if,service_handle);
}
...
static INT32 btmw_test_gatts_send_indication (INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_send_indication(server_if, attribute_handle, conn_id, confirm, p_value, value_len);
}
...
static INT32 btmw_test_gatts_send_response (INT32 argc, CHAR **argv)
{
    ...
    return c_btm_bt_gatts_send_response(conn_id, trans_id, status, handle, p_value, value_len, auth_req);
}
