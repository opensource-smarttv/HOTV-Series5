 ...
 */
static BT_AUDIO_SRC_CB_FUNC s_bt_a2dp_alsa_uploader =
{
...
static BtA2dpOutputCbk s_bt_a2dp_alsa_output_cb = NULL;
...
EXPORT_SYMBOL BT_AUDIO_SRC_CB_FUNC* bt_a2dp_alsa_getUploader(VOID)
{
    return &s_bt_a2dp_alsa_uploader;
}

EXPORT_SYMBOL VOID bt_a2dp_alsa_regOutputCallback(BtA2dpOutputCbk output_cb)
{
...
EXPORT_SYMBOL VOID bt_a2dp_alsa_setDebugFlag(INT32 flag, UINT32 value)
{
    switch (flag)
    {
#ifdef BT_ALSA_UPL_DEBUG
