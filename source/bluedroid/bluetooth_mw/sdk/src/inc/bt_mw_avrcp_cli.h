...
#ifndef __BT_MW_AVRCP_CLI_H__
#define __BT_MW_AVRCP_CLI_H__

INT32 _bluetooth_avrcp_passthrough_cmd_cli (INT32 argc, const CHAR **argv);

INT32 _bluetooth_avrcp_get_info_cli (INT32 argc, const CHAR **argv);

INT32 _bluetooth_avrcp_register_notification_cli (INT32 argc, const CHAR **argv);
