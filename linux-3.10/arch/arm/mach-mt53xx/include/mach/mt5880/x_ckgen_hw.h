...
#ifndef __X_5880_CKGEN_HW_H__
#define __X_5880_CKGEN_HW_H__
...
typedef enum
{
    ...
    CAL_SRC_FBOUT,                      // 0x0A
    CAL_SRC_USBPLL,                     // 0x0B
    CAL_SRC_ETHPLL_CLK675M_D2 = 13,        // 0x0D     ?
    CAL_SRC_XTAL,                       // 0x0E
    CAL_SRC_ADC_CKTOUT,                 // 0x0F
    CAL_SRC_AD_CVBSADC_CKIND,           // 0x10
    CAL_SRC_HDMI_PLL340M,
    CAL_SRC_HDMI_PIX340M,
    CAL_SRC_HDMI_0_DEEP340M_C,          // 0x13
    ...
    CAL_SRC_FB_OUT,                     // 0x2B
    CAL_SRC_SOGY_OUT_MON,               // 0x2C
    CAL_SRC_SOGY_OUT,                   // 0x2D
    CAL_SRC_VSYNC_OUT,                  // 0x2E
    CAL_SRC_HSYNC_OUT,                  // 0x2F
    ...
    CAL_SRC_CVBSADC_CKOUT_2,            // 0x37
    CAL_SRC_CVBSADC_CKIND,              // 0x38
    CAL_SRC_CVBSADC_CKOUT,              // 0x39
    CAL_SRC_HADDS3_CK_98M,              // 0x3A
    CAL_SRC_HADDS3_FBCLK_BUF,           // 0x3B
    CAL_SRC_PL_RCLK250,                 // 0x3C
    CAL_SRC_HADDS2_FBCLK_BUF,           // 0x3D
    CAL_SRC_PLLGP_TSTCK,                // 0x3E
    CAL_SRC_MJCPLL_FBCLK_BUF,           // 0x3F
    CAL_SRC_MJCPLL_REFCLK_BUF,          // 0x40
    CAL_SRC_CKT_B,                      // 0x41
    CAL_SRC_CKT_A,                      // 0x42

    CAL_SRC_USB20_MONCLK_1P = 0x45,    // 0x45
    CAL_SRC_USB20_MONCLK,               // 0x46
    CAL_SRC_MEMPLL_MONCLK_PRE,          // 0x47
    CAL_SRC_MEMFB_D16_CK,               // 0x48
    CAL_SRC_MEMREF_D16_CK,              // 0x49

    CAL_SRC_ADC_CKOUT = 0x4B,          // 0x4B
    CAL_SRC_AD_GPIO_PWM_0,              // 0x4C
    CAL_SRC_AD_GPIO_PWM_1,              // 0x4D
    CAL_SRC_AD_GPIO_PWM_2,              // 0x4E
    CAL_SRC_AD_GPIO_PWM_3,              // 0x4F
    CAL_SRC_AD_GPIO_PWM_4,              // 0x50
    CAL_SRC_AD_GPIO_PWM_5,              // 0x51
    CAL_SRC_MON_TCLK_DIV,               // 0x52
    CAL_SRC_MON_OCLK_DIV2,              // 0x53
    CAL_SRC_MON_OCLK_DIV,               // 0x54
    CAL_SRC_MON_CLK75M_CK,              // 0x55
    CAL_SRC_DDDS2_CK,                   // 0x56
    CAL_SRC_MAIN2_H,                    // 0x57
    CAL_SRC_BLK2RS_HS,                  // 0x58
    CAL_SRC_MIB_OUT_M_HS,               // 0x59
    CAL_SRC_MIO_CK_P0_DIV4,             // 0x5A
    CAL_SRC_MIO_CK_P0_DIV8,             // 0x5B
    CAL_SRC_PCIE_REF_CK,                // 0x5C
    CAL_SRC_AD_DMSS_VSP,                // 0x5D
    CAL_SRC_DA_HADDS3_REFCLK_216M,      // 0x5E
    CAL_SRC_DA_HADDS2_REFCLK_216M,      // 0x5F
    CAL_SRC_TAPLL_CK,                   // 0x60
    CAL_SRC_TAPLL_FBCLK_BUF,            // 0x61
    CAL_SRC_TAPLL_REFCLK_BUF,           // 0x62
    CAL_SRC_G3DPLL_FBCLK_BUF,           // 0x63
    CAL_SRC_G3DPLL_REFCLK_BUF,          // 0x64
    CAL_SRC_CPUPLL_MONCLK,              // 0x65

    SRC_CPU_CLK = 112,                  // 0x70
    SRC_MEM_CLK,                        // 0x71
    SRC_BUS_CLK,                        // 0x72
    SRC_TIMER_CLK,                      // 0x73
    SRC_SYSPLL_CLK,                     // 0x74
    SRC_APLL1_CLK,                      // 0x75
    SRC_APLL2_CLK,                      // 0x76
    SRC_SAWLESSPLL_CLK,                 // 0x77
    SRC_ADCPLL_CLK,                     // 0x78
    SRC_ETHPLL_CLK,                     // 0x79
    SRC_ETHNETPLL_CLK,                  // 0x7A
    SRC_VDECPLL_CLK,                    // 0x7B
    SRC_XPLL_CLK,                       // 0x7C
    SRC_VOPLL_CLK,                      // 0x7D

    SRC_POCLK = 128,                    // 0x80
    SRC_VDOIN_MPCLK,                    // 0x81
    SRC_MIB_OCLK,                       // 0x82
    SRC_POCLK_DPLL,                     // 0x83

    SRC_MJC_CLK = 144,                  // 0x90
    SRC_UNKNOWN
} CAL_SRC_T;
