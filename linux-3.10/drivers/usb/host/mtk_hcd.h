...
#if defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861) || defined(CONFIG_ARCH_MT5882)
...
uint8_t bMassStorageRxEnd;
	...
	uint8_t bMsdEndRxUsedCount;
	uint8_t bMsdEndTxUsedCount;
	uint8_t bMsdEndRxNum;
	uint8_t bMsdEndTxNum;
	uint8_t bMsdEndDoubleBuffer;
#endif
