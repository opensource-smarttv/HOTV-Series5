...
#define MSDC_BASE_ADDR            (u32) (0xF0012000)
...
#define ID2(cid)                         (((cid[1]&(0xFFFF<<0))<<16) | ((cid[2]&(0xFFFF<<16))>>16)) //to check
...
#define MSDC_IOCON_W_D1SPL_SHIFT        (11)     
#define MSDC_IOCON_W_D1SPL              ((0x01) << MSDC_IOCON_W_D1SPL_SHIFT)
#define MSDC_IOCON_W_D2SPL_SHIFT        (12)     
#define MSDC_IOCON_W_D2SPL              ((0x01) << MSDC_IOCON_W_D2SPL_SHIFT)
#define MSDC_IOCON_W_D3SPL_SHIFT        (13)     
#define MSDC_IOCON_W_D3SPL              ((0x01) << MSDC_IOCON_W_D3SPL_SHIFT)
...
/* MSDC_IOCON mask */
#define MSDC_IOCON_R_SMPL_SHIFT				(1)
#define MSDC_IOCON_R_SMPL						(0x01 << 1)

#define MSDC_IOCON_D_SMPL_SHIFT				(2)
#define MSDC_IOCON_D_SMPL						(0x01 << 2)

#define MSDC_IOCON_D_DLYLINE_SEL			(0x01 << 3)
#define MSDC_IOCON_R_D_SMPL_SEL				(0x01 << 5)

#define MSDC_IOCON_W_D_SMPL_SHIFT			(8)
#define MSDC_IOCON_W_D_SMPL_SEL				(0x01 << 8)

#define MSDC_IOCON_W_D_SMPL_SEL_SEL_SHIFT	(9)
#define MSDC_IOCON_W_D_SMPL_SEL_SEL		(0x01 << 9)

#define MSDC_IOCON_W_D0SPL					(0x01 << 10)
...
#define MSDC_CMD_DRV_VAL   60,  60,  60,  25, 23, 23, 16,  7,  7,  0
#define MSDC_DAT_DRV_VAL   60,  60,  60,  25, 23, 23, 16,  7,  7,  0
...
#define MSDC_CMD_DRV_VAL   	1,   1,   1,   1,  1,  1,  1,  1,  1,  0
#define MSDC_DAT_DRV_VAL   	1,   1,   1,   1,  1,  1,  1,  1,  1,  0
#define MSDC_CLK_SAMP_VAL 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x0, 0x0, 0x0, 0x0
#endif
typedef enum
{
...
//#define MSDC_CLK_SRC_VAL   11, 11, 11,  0,  0
//#define MSDC_CLK_MODE_VAL   0,  2,  0,  0,  0
//#define MSDC_CLK_DIV_VAL    1,  0,  2,  0, 16
//#define MSDC_CLK_DRV_VAL   16, 16,  7,  7,  0
//#define MSDC_CMD_DRV_VAL   0, 0,  0,  0,  0
//#define MSDC_DAT_DRV_VAL  0, 0,  0,  0,  0
//#define MSDC_CLK_SAMP_VAL 0x6, 0x0, 0x0, 0x0, 0x0
...
#define MSDC_BITVAL(addr, dBit)        ((sdr_read32(addr)>>dBit) & (0x01))  
#if defined(CC_MT5399) || defined(CONFIG_ARCH_MT5399)|| defined(CC_MT5890)|| defined(CONFIG_ARCH_MT5890)|| \
    defined(CC_MT5882) || defined(CONFIG_ARCH_MT5882)
// Get gpio value
